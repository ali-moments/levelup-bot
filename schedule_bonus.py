#!/usr/bin/env python3
"""Schedule bonus messages for 24 hours using Telegram's scheduled message feature.
...
5. Continue scheduling until 24 hours are covered
...
async def schedule_bonus_messages():
    ...
    logger.info("=" * 60)
    logger.info("Starting bonus message scheduler (24 hours)")
    logger.info("=" * 60)
    ...
    try:
        ...
        target_duration = timedelta(hours=24)  # Schedule for 24 hours
        ...
        logger.info(f"Target duration: 24 hours")
        logger.info("=" * 60)
        ...
        while cumulative_time < target_duration:
            ...
            # Stop if we've exceeded 24 hours
            if cumulative_time >= target_duration:
                break
        ...
        logger.info(f"Total messages scheduled: {message_count}")
